...
plot<- ggplot(a, aes(x=slug, y= first_historical_data)) + 
  ...
  theme(panel.background = element_rect(fill = "#fbf7f0",colour = "#fbf7f0")) +labs(colour = "colour_up", fill = "fill_up") + theme(plot.background = element_rect(fill = "#fbf7f0"))
...
```
Vemos como los máximos retornos desde el 2015 tanto positivos como negativos del S&P fueron de alrededor de un 10%y un -15%. Sin embargo vemos como los del ethereum son mucho más grandes, habiendo retornos de más del 25% e incluso del 40%, lo que es un indicio de una mayor volatilidad del ethereum.
